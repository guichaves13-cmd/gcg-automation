...
const SCRIPT_TEMPLATES = [
  ...
  // ─── Novos templates v1.1 (HeyGen-killer) ───
  { icon: '💡', name: 'Curiosidade rápida', niche: 'Edutainment',
    desc: 'Fato surpreendente em 15-30s. Viral em TikTok.',
    voice: 'friendly_explainer',
    text: 'Você sabia que [FATO SURPREENDENTE]? Pesquisas mostram que [DADO]. E o mais incrível: [DETALHE INESPERADO]. Compartilha com quem precisa saber!' },
  { icon: '🛒', name: 'Review de produto', niche: 'E-commerce',
    desc: 'Avaliação balanceada. Ideal p/ afiliados/lançamentos.',
    voice: 'sales_pitch',
    text: 'Testei o [PRODUTO] por [TEMPO] e vou ser honesto: [VEREDICTO]. O que mais gostei foi [PRÓ 1] e [PRÓ 2]. Por outro lado, [CONTRA]. Vale a pena? Se você [PERFIL DO COMPRADOR], sim. Link na descrição.' },
  { icon: '❓', name: 'Pergunta polêmica', niche: 'Engajamento',
    desc: 'Hook que provoca comentários. 15-30s.',
    voice: 'friendly_explainer',
    text: 'Pergunta polêmica do dia: [PERGUNTA]? Tem gente que diz [POSIÇÃO A]. Outros defendem [POSIÇÃO B]. E você, o que acha? Comenta aí sua opinião. Spoiler: eu prefiro [SUA RESPOSTA].' },
  { icon: '⚡', name: 'Hack/dica em 30s', niche: 'Lifestyle',
    desc: 'Vida prática melhor com 1 truque. Loop em Reels.',
    voice: 'friendly_explainer',
    text: 'Hack incrível pra [SITUAÇÃO COMUM]: ao invés de [JEITO ANTIGO], faça [NOVO JEITO]. Em 30 segundos você economiza [TEMPO/DINHEIRO]. Eu uso esse truque todo dia. Compartilha pra economizar tempo dos amigos!' },
  { icon: '📊', name: 'Análise/dados', niche: 'B2B/Profissional',
    desc: 'Insight com números. Ideal LinkedIn/relatórios.',
    voice: 'corporate_trainer',
    text: 'A maior surpresa do relatório de [MÊS/ANO] foi [DADO PRINCIPAL]. Isso significa [INTERPRETAÇÃO]. Para gestores, a oportunidade é [AÇÃO RECOMENDADA]. Eu detalho o estudo completo no link.' },
  { icon: '🎯', name: 'Estudo de caso', niche: 'B2B/Vendas',
    desc: 'Cliente conseguiu X usando Y. Prova social.',
    voice: 'corporate_trainer',
    text: 'Conheça a história da [EMPRESA/CLIENTE]. Eles enfrentavam [PROBLEMA] há [TEMPO]. Depois de implementar [SOLUÇÃO], em [PRAZO] alcançaram [RESULTADO MENSURÁVEL]. Quer um caso assim no seu negócio? Fala comigo.' },
  { icon: '🏥', name: 'Conteúdo de saúde', niche: 'Médico/Bem-estar',
    desc: 'Educação em saúde acessível. Sempre com disclaimer.',
    voice: 'friendly_explainer',
    text: 'Olá, sou [PROFISSIONAL]. Hoje quero falar sobre [TÓPICO DE SAÚDE]. Muitos pacientes me perguntam: [PERGUNTA COMUM]. A resposta é: [EXPLICAÇÃO BREVE]. Importante: isso é informação geral, não substitui consulta. Cuide-se!' },
  { icon: '🍽️', name: 'Receita / culinária', niche: 'Food',
    desc: 'Passo-a-passo de receita. Ideal p/ Instagram.',
    voice: 'friendly_explainer',
    text: 'Receita de [PRATO] super fácil em 5 passos. Ingredientes: [LISTA]. Comece [PASSO 1]. Depois [PASSO 2]. Em seguida [PASSO 3]. Quase pronto: [PASSO 4]. Finalize com [PASSO 5]. Bom apetite! Salva pra fazer depois.' },
  { icon: '🏋️', name: 'Treino / fitness', niche: 'Fitness',
    desc: 'Instrução de exercício. Ideal Reels fitness.',
    voice: 'sales_pitch',
    text: 'Vamos pra um treino rápido de [PARTE DO CORPO] em 5 minutos. Comece com [EXERCÍCIO 1] por 30 segundos. Descanse 10. Agora [EXERCÍCIO 2] por 30 segundos. Última rodada: [EXERCÍCIO 3]. Sentiu? Compartilha com quem precisa começar hoje!' },
  { icon: '✈️', name: 'Travel / viagem', niche: 'Travel/Lifestyle',
    desc: 'Dica de destino. Ideal carrossel + Reels.',
    voice: 'friendly_explainer',
    text: 'Se você vai pra [DESTINO], precisa saber: [DICA INSIDER]. A maioria dos turistas faz [ERRO COMUM], mas o segredo é [ALTERNATIVA MELHOR]. Eu economizei [BENEFÍCIO] usando esse truque. Salva pra próxima viagem!' },
  { icon: '🧠', name: 'Filosofia / reflexão', niche: 'Mindset',
    desc: 'Pensamento profundo em 30-60s.',
    voice: 'documentary_narrator',
    text: 'Há uma pergunta que mudou minha forma de pensar: [PERGUNTA FILOSÓFICA]. A maioria de nós passa a vida [COMPORTAMENTO COMUM]. Mas e se [REFRAME]? Talvez a resposta esteja em [INSIGHT FINAL]. Reflita.' },
  { icon: '💼', name: 'Pitch de startup', niche: 'Negócios/Investidores',
    desc: 'Elevator pitch 60s. Ideal p/ investidores.',
    voice: 'sales_pitch',
    text: 'Conheça [NOME DA STARTUP]. Nós resolvemos [PROBLEMA] para [PÚBLICO ALVO]. O mercado atual de [VERTICAL] tem [TAMANHO] mas é [LIMITAÇÃO]. Nossa solução: [DIFERENCIAL ÚNICO]. Tração: [MÉTRICAS]. Estamos abrindo rodada de [VALOR]. Vamos conversar?' },
  { icon: '🎮', name: 'Gaming / streamer', niche: 'Gaming',
    desc: 'Intro de stream/vídeo gaming. Tom hype.',
    voice: 'sales_pitch',
    text: 'E aí galera, tudo bom? Hoje vamos jogar [JOGO] e o objetivo é [META]. Quem nunca jogou esse jogo: ele é sobre [CONTEXTO]. Acompanhem que vai ser muito top. Deixa o like, ativa o sino e vamo que vamo!' },
  { icon: '📚', name: 'Resumo de livro', niche: 'Edutainment',
    desc: '3 lições principais em 60-90s.',
    voice: 'corporate_trainer',
    text: 'Resumo de [LIVRO] do autor [NOME]. Três lições que vão mudar como você [DOMÍNIO]. Primeira: [LIÇÃO 1]. Segunda: [LIÇÃO 2]. Terceira, e mais importante: [LIÇÃO 3]. Salva esse vídeo pra revisitar.' },
  { icon: '🎤', name: 'Episódio de podcast — abertura', niche: 'Podcast',
    desc: 'Abertura formal com tema do episódio.',
    voice: 'podcast_host',
    text: 'Olá pessoal, bem-vindos a mais um episódio do [NOME DO PODCAST]. Eu sou [SEU NOME] e hoje vou conversar sobre [TEMA]. Esse assunto é importante porque [RELEVÂNCIA]. Pra me ajudar com isso, hoje recebo [CONVIDADO ou CONTEXTO]. Bora começar!' },
  { icon: '📅', name: 'Atualização semanal', niche: 'Newsletter/Vlog',
    desc: 'Recap da semana. Ideal p/ newsletter de vídeo.',
    voice: 'friendly_explainer',
    text: 'Resumo da semana: três coisas que aconteceram. Primeiro, [ACONTECIMENTO 1]. Depois, [ACONTECIMENTO 2]. E pra fechar, [ACONTECIMENTO 3]. O que vem na próxima semana? [TEASER]. Te vejo segunda!' },
  { icon: '🎁', name: 'Anúncio de promoção', niche: 'E-commerce',
    desc: 'Urgência + oferta + CTA. 15-30s.',
    voice: 'sales_pitch',
    text: 'ATENÇÃO! Promoção relâmpago: [PRODUTO] com [DESCONTO]% OFF. Só hoje, ou até esgotar. Use o cupom [CÓDIGO] no checkout. Frete grátis pra todo Brasil. Clique no link agora antes que acabe!' },
  { icon: '🤝', name: 'Convite de evento', niche: 'Eventos',
    desc: 'Save the date + CTA inscrição.',
    voice: 'friendly_explainer',
    text: 'Anote na sua agenda: dia [DATA], às [HORA], vai rolar [EVENTO]. Será [ONLINE/PRESENCIAL] em [LOCAL/PLATAFORMA]. Quem participar vai aprender [BENEFÍCIO]. Vagas limitadas — inscreva-se pelo link da bio.' },
  { icon: '🎵', name: 'Teaser musical', niche: 'Música',
    desc: 'Prévia de lançamento. Tom misterioso 15s.',
    voice: 'documentary_narrator',
    text: 'Em breve. Algo novo. Algo intenso. [NOME DO ARTISTA / BAND] traz [MÚSICA / ÁLBUM]. Disponível em todas as plataformas a partir de [DATA]. Não perca. Pré-save no link.' },
  { icon: '🛠️', name: 'Suporte técnico — FAQ', niche: 'Suporte',
    desc: 'Resposta clara a problema comum.',
    voice: 'corporate_trainer',
    text: 'Recebemos muitas perguntas sobre [PROBLEMA]. A solução é simples: [PASSO 1]. Se não resolver, tente [PASSO 2]. Ainda com problema? Abre um ticket no link da descrição. Nossa equipe responde em até 24h.' },
  { icon: '🎂', name: 'Mensagem de aniversário', niche: 'Pessoal',
    desc: 'Felicitação personalizada. Ideal video DM.',
    voice: 'friendly_explainer',
    text: 'Olá [NOME]! Hoje é seu dia especial e eu quero te desejar tudo de bom. Que esse novo ciclo seja repleto de [DESEJO 1], [DESEJO 2] e muita [DESEJO 3]. Você merece tudo de melhor. Parabéns, feliz aniversário!' },
];
